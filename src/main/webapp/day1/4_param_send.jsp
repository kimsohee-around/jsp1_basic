...
<body>
	...
	<ul>
		...
		<li>
			<a href="5_param_receive.jsp?name=김사나&age=">name,age 2개의 파라미터 보내기- age 값 없을 때</a>
			<!-- age는 length가 0인 문자열 -->
		</li>
	</ul>
	<hr>
	...
	<ul>
		<li>
			<a href="6_selectBy.jsp?name=김사나&age=23">name,age 2개의 파라미터 보내기(조회 결과 있음)</a>
			<!-- 2개 값이 모두 출력됩니다. -->
		</li>
		<li>
			<a href="6_selectBy.jsp?name=김사나&age=24">name,age 2개의 파라미터 보내기(조회 결과 없음)</a>
			<!-- 2개 값이 모두 출력됩니다. -->
		</li>
		<li>
